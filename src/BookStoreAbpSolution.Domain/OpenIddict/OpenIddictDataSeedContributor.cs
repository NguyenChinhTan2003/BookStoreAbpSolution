...
namespace BookStoreAbpSolution.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("BookStoreAbpSolution") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "BookStoreAbpSolution", DisplayName = "BookStoreAbpSolution API", Resources = { "BookStoreAbpSolution" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["BookStoreAbpSolution_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl = configurationSection["BookStoreAbpSolution_App:RootUrl"]?.TrimEnd('/');
        ...
        // Blazor Client
        var blazorClientId = configurationSection["BookStoreAbpSolution_Blazor:ClientId"];
        if (!blazorClientId.IsNullOrWhiteSpace())
        {
            var blazorRootUrl = configurationSection["BookStoreAbpSolution_Blazor:RootUrl"]?.TrimEnd('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["BookStoreAbpSolution_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["BookStoreAbpSolution_Swagger:RootUrl"]?.TrimEnd('/');
