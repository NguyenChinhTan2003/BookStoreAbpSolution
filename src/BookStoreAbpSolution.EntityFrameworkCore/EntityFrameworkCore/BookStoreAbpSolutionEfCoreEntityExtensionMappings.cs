...
public static class BookStoreAbpSolutionEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE BookStoreAbpSolutionModuleExtensionConfigurator CLASS (in the Domain.Shared project)
