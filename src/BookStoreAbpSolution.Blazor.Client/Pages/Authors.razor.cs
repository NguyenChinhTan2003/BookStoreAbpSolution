...
namespace BookStoreAbpSolution.Blazor.Client.Pages;
public partial class Authors
{
    ...
    private async Task SetPermissionsAsync()
    {
        CanCreateAuthor = await AuthorizationService
            .IsGrantedAsync(BookStoreAbpSolutionPermissions.Authors.Create);

        CanEditAuthor = await AuthorizationService
            .IsGrantedAsync(BookStoreAbpSolutionPermissions.Authors.Edit);

        CanDeleteAuthor = await AuthorizationService
            .IsGrantedAsync(BookStoreAbpSolutionPermissions.Authors.Delete);
    }
